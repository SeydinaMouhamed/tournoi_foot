...
$(document).ready(function() {
	...
	$('#demo-bv-wz-form').bootstrapValidator({
		...
		tournoisName: {
			validators:{
				notEmpty:{
					message:'Le nom du tournoi ne doit pas être vide!'
				}
			}
		}
		,
		tournoisApropos: {
			validators:{
				notEmpty:{
					message:'Une description du tournoi est nécessaire'
				}
			}
		}
		,
		imgPubTournoi: {
			...
			validators: {
				notEmpty:{
					message: 'Vous devez choisir une image publicitaire pour le tournoi'
				}
			}
		}
		,
		imgStade: {
			...
			validators: {
				notEmpty:{
					message: 'Vous devez choisir un stade'
				}
			}
		},
		imgJoueur:{
			validators: {
				notEmpty:{
					message: 'Vous devez choisir un joueur'
				}
			}
		}
		,
